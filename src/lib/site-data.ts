import {
  Home, Shield, Flag, FileText, Building2, TrendingUp,
  Wallet, Hammer, Link2, Hotel, Globe, Coins, AlertCircle, Banknote,
  type LucideIcon,
} from "lucide-react";
...
export const PROGRAMS: Program[] = [
  { name: "Conventional", description: "Fannie & Freddie loans with the lowest market rates.", icon: Home },
  ...
  { name: "Bank Statement", description: "Qualify on deposits — perfect for self-employed.", icon: FileText },
  { name: "DSCR", description: "Investor loans qualified on rental income only.", icon: TrendingUp },
  ...
  { name: "Hotel & Commercial", description: "Hospitality and commercial real estate.", icon: Hotel },
  { name: "Foreign National", description: "U.S. property financing for non-residents.", icon: Globe },
  { name: "Asset-Based", description: "Qualify on assets, not income documentation.", icon: Coins },
  { name: "Low Credit Score", description: "Solutions for credit scores below 620.", icon: AlertCircle },
